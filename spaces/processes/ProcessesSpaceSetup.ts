...
export class ProcessesSpaceSetup {
    ...
    static async setup(notu: Notu): Promise<void> {
        ...
        if (!processesSpace) {
            ...
            noteProcess.addTag(process.ownTag);
            ...
            pageProcess.addTag(process.ownTag);

            await notu.saveNotes([noteProcess, pageProcess]);
            ...
            createNoteProcess.addTag(noteProcess.ownTag);
            createNoteProcess.addTag(pageProcess.ownTag);
            ...
            editNoteProcess.addTag(noteProcess.ownTag);
            ...
            deleteNoteProcess.addTag(noteProcess.ownTag);
